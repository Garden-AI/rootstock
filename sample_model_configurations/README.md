...
└── nvidia_configs/     # configs targeting NVIDIA GPUs
    ...
    ├── dimenet_env.py      # DimeNet++ (OC20 catalysis)
    ├── equiformer_env.py   # EquiformerV2 (OC20 catalysis)
    ├── escn_env.py         # eSCN (OC20 catalysis)
    ├── esen_env.py         # eSEN — FAIRChem single-task (OMol25/OC25/ODAC25)
    ├── gemnet_env.py       # GemNet-OC / GemNet-dT (OC20 catalysis)
    ...
    ├── painn_env.py        # PaiNN (OC20 catalysis)
    ├── schnet_env.py       # SchNet (OC20 catalysis)
    ├── scn_env.py          # SCN (OC20 catalysis)
